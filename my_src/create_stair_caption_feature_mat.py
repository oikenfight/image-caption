...
if __name__ == "__main__":
    ...
    for image_data in train_dataset['images']:
        ...
        features['imgid' + str(image_id)] = np.array(feature)
        print(features['imgid' + str(image_id)])
        cnt += 1
        if cnt == 5:
            break
    ...
    # matfile を作成
    print()
    print('======= create matfile =================')
    print(type(features))
    print(len(features))
    print(features)
    scipy.io.savemat("test.mat", {'name': features})
